function obtenerComprobanteFirmado_sri(ruta_certificado, pwd_p12, ruta_respuesta, ruta_factura, token, claveDeAcceso, id_prefac) {
        ...
        oReq.onload = function (oEvent) {
            ...
            $.ajax({
                ...
                $.ajax({
                    ...
                    console.log('respuesta validar coprobante ', respuestaValidarComprobante);
    ...
    oReq.onload = function (oEvent) {
        ...
        $.ajax({
            ...
            $.ajax({
                type: 'POST',
                url: ruta_respuesta,
                data: {'respuestaValidarVigencia': response, 'claveacceso': claveDeAcceso},
                context: document.body
            }).done(function (respuesta) {
                return true;
            });
    ...
    oReq.onload = function (oEvent) {
        ...
        try {
            ...
            $.ajax({
                type: 'POST',
                url: ruta_respuesta,
                data: {'respuestaValidarContraseña': 'Contraseña Correcta', 'claveacceso': claveDeAcceso},
                context: document.body
            }).done(function (respuesta) {
            ...
            $.ajax({
                type: 'POST',
                url: ruta_respuesta,
                data: {'respuestaValidarContraseña': 'Contraseña Invalida', 'claveacceso': claveDeAcceso},
                context: document.body
            }).done(function (respuesta) {
